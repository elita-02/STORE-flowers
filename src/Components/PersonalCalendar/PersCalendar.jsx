...
// import './PersCalendar.scss'; // SCSS стилдер
...
//       } else {
//         setUserEmail(null);
//         toast.error('Авторизация не выполнена', { position: 'top-right', autoClose: 3000 });
//       }
//     });
//     return () => unsubscribe();
//   }, []);

//   // Колдонуучу логин болгондо гана тост чыгат
//   useEffect(() => {
//     if (userEmail) {
...
//         email: userEmail
//       });
//       toast.success(`"${newEvent.name}" добавлен на ${newEvent.date}`, { position: 'top-right', autoClose: 3000 });
//       setNewEvent({
//         name: '',
//         date: '',
//         phone: '',
...
//       });
//     } else {
//       toast.error('Пожалуйста, заполните обязательные поля', { position: 'top-right', autoClose: 3000 });
//     }
//   };
